...
<html lang="en">
  ...
  <body>
    ...
    <form method="post" action="multiDeleteFunc.php">
        <center>
            <table style="width:90%">
                <tr>
                    <th><center>Product Code</center></th>
                    <th><center>Product Name</center></th>
                    <th><center>Product Line</center></th>
                    <th><center>Product Scale</center></th>
                    <th><center>Product Vendor</center></th>
                    <th><center>Product Descripttion</center></th>
                    <th><center>Quantity In Stock</center></th>
                    <th><center>Buy Price</center></th>
                ...
                <tr>
                    ...
                    <td><center><input type="checkbox" name='id[]' value="<?php echo $row[0]?>" /></center></td>
                    <td><center><a href="editProduct.php?id=<?php echo $row[0]?>">Edit</a></center></td>
                </tr>
                <?php } ?>
            </table><br>
