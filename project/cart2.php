...
<ul>
  ...
  <li><a href="cart1.php" >ProductVender</a></li>
...
<?php 
   ...
   require'./connect.php';
    ...
    $sqls2 = "select * from products where productScale like '%$search2%' order by productCode";
    $result1 = mysqli_query($connect,$sqls2);
   

    $sql="select distinct productScale from products Order by productScale";
