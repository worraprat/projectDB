  ...
  <body>
    ...
    <div class="container">
      <form method="POST" action='insertdiscount.php'>
          ...
          Enter Amount: <input type = "number" name = 'amount' required max="100" min="1"> <br><br>
          Enter Ex Date: <input type = "date" name = 'exDate' required> <br><br>
          Enter Quantity: <input type = "number" name = 'quantity' required max="1000" min="1"> <br><br>
