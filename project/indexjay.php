...
?>
    ...
    <br><br><br><br><div class="container" style="width:900px;margin-left:270px">
    <?php
        while($row=mysqli_fetch_array($result)){
    ?>
    <div class="col-md-6" style="position:static;">
    <form method="post" action="test.php?action=add&id=<?php echo $row['productCode'];?>">
        ...
        <?php
          if(!empty($_SESSION["shopping_cart"])){
              ...
              <tr>
                ...
                <td><a href="test.php?action=delete&id=<?php echo $value['item_id'];?>">Delete Product</td>
              </tr>
          <?php
